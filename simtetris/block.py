...
class Block:
    ...
    def rotatable(self, board_array):
    ...
    def rotate(self, board_array):
        ...
        if self.name != 'K' and self.rotatable(board_array):
            height = self.rows
            width = self.cols
            temp = []
            for v in self.array:
